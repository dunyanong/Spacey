...
export default function Customise() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center text-gray-800 bg-white -mt-12">
            ...
            <form className="flex flex-col items-center space-y-4 w-full max-w-md mt-4">
                <input type="email" id="email" className="rounded-lg px-4 py-3 w-full border border-gray-300 focus:outline-none focus:border-blue-500" placeholder="Your Email" />
                <button type="submit" className="bg-black hover:bg-white text-white hover:text-black hover:border-black-20 font-semibold rounded-lg px-6 py-3 transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Subscribe
                </button>
            </form>
