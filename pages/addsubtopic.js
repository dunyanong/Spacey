    ...
    return (
      <Box className="md:p-5 w-full max-w-3xl mx-auto pt-20">
        ...
        <VStack spacing={6} pt={10} pb={12} align="start">
          <Heading as="h1" size="xl">1. Add your subtopic</Heading>
          <Box as="form" onSubmit={submitMessage} w="full">
            ...
            <div className="mb-5 mt-20">
              <Heading as="h1" size="xl">2. How confident are you?</Heading>
            </div>
            <div className="w-full flex flex-col items-center border border-gray-200 rounded-lg px-4 py-2 mb-3 relative overflow-hidden p-2">
